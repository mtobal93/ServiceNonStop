...
from app.models import Review, Image, Company, User, db
...
def update_review(id):
    """
    Updates an existing review if it is owned by user logged in
    """
    review = Review.query.get(id)
...
def delete_review(review_id):
    ...
    if review is None:
        ...
        try: 
            ...
            db.session.rollback()
            return {'message': 'An unknown error occured while attempting to delete the review. Please refresh the page and try again.'}, 500
