...
const FilterComponent = ({ onFilterChange, isMobile, isTablet }) => {
    ...
    const [price, setPrice] = useState([
        {
            name: "$",
            checked:
                searchParams.get("price")?.split(",").includes("$") || false,
        },
        {
            name: "$$",
            checked:
        ...
        setPrice([
            {
                name: "$",
                checked:
                    searchParamss.get("price")?.split(",").includes("$") ||
                    false,
            },
            {
                name: "$$",
    ...
    return isMobile || isTablet ? (
        ...
        <>
            <div className="filterComponent">
            <h1 className="result-word">Filters: </h1>
                    ...
                    {price.map((char, index) => (
                        <label key={char.name}>
                            <input
                                ...
                                checked={char.checked}
                                onChange={() =>
                                    updatePrice(index, !char.checked)
                                }
                            />
                            {char.name}&nbsp;&nbsp;
                        </label>
