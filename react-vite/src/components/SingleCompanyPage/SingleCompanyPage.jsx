            ...
            <>
                <div className="businessPhotoHeader">
                    {company.company_images?.[0] ? (
                        <img
                            src={company.company_images?.[0]?.image_url}
                    ...
                    <div className="businessHeader">
                        <div className="compName">
                            ...
                            {company.phone && (
                                <>
                                    <div className="compNumContainer">
                                        <div className="compNum">
                                            <a
                            ...
                            {company.reviews?.num_reviews > 1 && (
                                <p className="businessReviews">
                                    ...
                                    &nbsp;&nbsp;{" "}
                                    {company.reviews.avg_stars &&
                                        reviewAvg(company.reviews.avg_stars)}
                                    &nbsp;({company.reviews.num_reviews}{" "}
                                    reviews)
                                </p>
                            )}
                            {company.reviews?.num_reviews === 1 && (
                                    ...
                                    getTodaysHours(company) && (
                                        <span className="currHoursSection">
                                            <span>
                                                ...
                                                {getTodaysHours(company).open} -{" "}
                                                {getTodaysHours(company).close}
                                                &nbsp;&nbsp;
                                            </span>
                                            <span
                                                className="seeHours"
