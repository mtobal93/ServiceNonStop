                    ...
                    <div className="user-sidebar-container">
                        <div className="user-summary-container">
                            ...
                            <div className="user-summ-stats">
                                <div className="user-summ-stat-item"><i className="fa-solid fa-tool" />&nbsp;&nbsp;<span>{viewedUser.num_reviews}</span></div>&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <div className="user-navigation-container">
                            {(isMobile || isTablet) ? (
                                ...
                                <>
                                    ...
                                    <span className="single-user-navigation" onClick={() => { setCurrentView('reviews') }}><h4 className="nav-description"><i className="fa-solid fa-tool" />&nbsp;&nbsp;Reviews Written</h4></span>
