...
function ManageCompanyPage() {
    ...
    const sessionUser = Object.values(
        useSelector((state) => (state.session.user ? state.session.user : []))
    );
                    ...
                    <div key={company.id} className="bizandbutton">
                        ...
                        >
                            ...
                            <span className="businessDeets">
                                ...
                                {/* {company.avg_stars &&
                                    company.num_reviews &&
                                    reviewsExists(company.num_reviews) && (
                                        <span className="searchStars">
                                            {company?.avg_stars &&
                                                starReviews(company.avg_stars)}
                                            &nbsp;
                                            {company?.avg_stars &&
                                                starsToFixed(company.avg_stars)}
                                            &nbsp;
                                            {company.num_reviews >= 1 &&
                                                reviewsExists(
                                                    company.num_reviews
                                                )}
                                        </span>
...
{!company.price ? (
                                ...
                                <span className="recent-review-text">
                                    {company.description &&
                                        descriptionTextSubstr(
                                            company.description
                                        )}
                                </span>
                            </span>
                ...
                <div className="no-biz">
                    <div>
                        It looks like you don&apos;t have any companies listed
                        on Service Non Stop.
                    </div>
                    &nbsp;
                    <Link to={"/companies/new"}>
                        Add your company to Service Non Stop!
                    </Link>
                </div>
            )}
        </div>
